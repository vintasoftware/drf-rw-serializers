...
"""
drf-rw-serializers documentation build configuration file.
...
project = 'drf-rw-serializers'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'drf-rw-serializers'
...
#
# html_title = 'drf-rw-serializers v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Generic views, viewsets and mixins that extend the Django REST Framework ones adding separated serializers for read and write operations',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'drf_rw_serializers'),
                os.path.join(root_path, 'drf_rw_serializers/migrations')])
